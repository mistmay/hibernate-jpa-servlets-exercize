...
%>
<h2 class="fs-4 fw-bold text-center mb-2">Le pizze di <%= currentUser.getUsername() %></h2>
<%
...
<table class="table text-center">
 ...
 %>
 <h3 class="fs-5 fw-bold text-center">Questo utente non ha ancora creato pizze</h3>
<% 
    }
    }
%>